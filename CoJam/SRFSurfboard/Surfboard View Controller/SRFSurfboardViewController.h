...
/**
 Configure the pagecontol tint color.
 
 @param tintColor Tint color for the page control.
 @param selectedColor Selected tint color for the page control.
 */
- (void) setPageControl: (UIColor*)tintColor andSelectedColor:(UIColor*) selectedColor;
